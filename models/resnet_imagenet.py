...
class ResNet_n(nn.Module):
    def __init__(self, block, layers, num_classes=1000, number_net=2):
...
def resnet18(num_classes, number_net):
    if number_net == 2:
        ...
        arch = ResNet_b
    return arch(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, number_net=number_net)
...
def resnet34(num_classes, number_net):
    if number_net == 2:
        ...
        arch = ResNet_b
    return arch(BasicBlock, [3, 4, 6, 3], num_classes=num_classes, number_net=number_net)


if __name__ == '__main__':
    net = resnet18(num_classes=1000, number_net=2)
